	...
	<div id="main">
		...
		<table cellpadding="5">
			...
			<tr>
				...
				<td>&nbsp;</td>
				<td><?php echo Zamp::$core->systemTime('jS M Y, h:i:s a', $errorTimeDiffFromGmt).' (GMT '.$timeZoneFormat.')'; ?></td>
			</tr>
		</table>
		<br/>
		...
		<table cellpadding="5" id="_Get" style="display:none;">
			<tr>
				<td align="left">
						<pre>
							<?php var_dump(Zamp::$core->_request->get()); ?>
						</pre>
				</td>
			</tr>
		</table>
